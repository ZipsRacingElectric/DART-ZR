...
exec cage -- $ZRE_CANTOOLS_DIR/bin/dashboard-gui $ZRE_CANTOOLS_DIR/config/zr25/vehicle/dashboard_gui.json can0@1000000 $ZRE_CANTOOLS_DIR/config/zr25/vehicle/main.dbc

...
exec $ZRE_CANTOOLS_DIR/bin/dashboard-gui $ZRE_CANTOOLS_DIR/config/zr25_glory/dashboard_vehicle_config.json vcan@1000000 $ZRE_CANTOOLS_DIR/config/zr25_glory/can_vehicle.dbc